/* global React */
const QuadrantCard = ({ q, title, subtitle, tasks = [], onDrop, onToggle }) => {
  ...
  return (
    ...
    >
      <div style={{
        ...
        <div>
          <div style={{
            fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 500, fontSize: 11,
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
        {tasks.length === 0 ? (
          ...
          tasks.map(t => (
            ...
            >
              <button onClick={() => onToggle && onToggle(t.id)}
                      style={{
...
window.QuadrantCard = QuadrantCard;
