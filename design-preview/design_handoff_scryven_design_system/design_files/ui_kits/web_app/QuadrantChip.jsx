/* global React */
// QuadrantChip — pill badge identifying a task's quadrant.
// q is one of 'q1' | 'q2' | 'q3' | 'q4' | 'g'.
const QUAD_META = {
...
const QuadrantChip = ({ q = 'q2', size = 'md', label, showGlyph = true }) => {
...
window.QuadrantChip = QuadrantChip;
window.QUAD_META = QUAD_META;
